...
@section('main-content')
    ...
    <!-- Page Heading -->
    <marquee><h1 class="h3 mb-4 text-gray-800">Selamat Datang Di Sistem Manajemen Peprustakaan SMAN 1 Kota Depok</h1></marquee>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">43.230</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
      <img src="{{asset('img/logosmansa.png')}}" id="banner" class="center" alt="">
    </div>
